...
_G.packer_plugins = {
  ...
  ["nord.nvim"] = {
    loaded = true,
    path = "/Users/Vinensius.Wibowo/.local/share/nvim/site/pack/packer/start/nord.nvim",
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/Users/Vinensius.Wibowo/.local/share/nvim/site/pack/packer/start/onedark.nvim",
